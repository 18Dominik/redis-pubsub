...
```
cd existing_repo
git remote add origin https://git.dzbank.vrnet/techlab/nodejs/redis-pubsub.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.dzbank.vrnet/techlab/nodejs/redis-pubsub/-/settings/integrations)
